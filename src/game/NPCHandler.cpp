...
void WorldSession::HandleGossipHelloOpcode( WorldPacket & recv_data )
{
	...
	if(unit->isBotGiver())
	{
        ...
        unit->prepareGossipMenu(GetPlayer(),GOSSIP_OPTION_HEALBOT);
...
void WorldSession::HandleGossipSelectOptionOpcode( WorldPacket & recv_data )
{
	...
	if(unit->isBotGiver())
	{
		...
		if(m_session->GetHealbot(guidlo) != NULL)
		{
			m_session->LogoutHealbot(guidlo, true);
		}
		else if(m_session->GetHealbot(guidlo) == NULL)
		{
			m_session->AddHealbot(guidlo);
		}
